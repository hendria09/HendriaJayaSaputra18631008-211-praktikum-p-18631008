...
-- Dumping data for table praktikum_presensi_pengajian.bagian: ~3 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.jabatan: ~5 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.karyawan: ~8 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.lokasi: ~3 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.penggajian: ~18 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.pengguna: ~8 rows (approximately)
...
-- Dumping data for table praktikum_presensi_pengajian.presensi: ~552 rows (approximately)
